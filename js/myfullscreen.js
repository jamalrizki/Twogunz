...
$(function(){
    ...
    var playerTrack = $("#player-track"), 
      ...
      albums = ['Rick Surf','Brad Pitted','Hattori Outlaw','Larz Ul Rich'], 

      trackNames = ['Two Gunz Gonzo - Rick Surf','Two Gunz Gonzo - Rick Surf','Two Gunz Gonzo - Rick Surf','Two Gunz Gonzo - Rick Surf'], 

      albumArtworks = ['_1','_2','_3','_4'],

      trackUrl = ['music/rocksurk.mp3','music/brad.mp3','music/hattori.mp3','music/larz.mp3'],
